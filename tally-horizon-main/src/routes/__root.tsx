...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#ff7a18" },
      ...
      { property: "og:title", content: "Tally Accounting Hub Pro" },
      { property: "og:description", content: "Learn. Grow. Earn. Premium EdTech for Hindi & Nepali learners." },
